...
import com.joke.template.asynctask.TestAsyncClass;
import com.joke.template.handlertype.MsgHandlerType;

public abstract class SuperTabActivity extends TabActivity implements
		ActivityStatus {
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	public void InitStart(int arg1) {
		...
		msg.what = MsgHandlerType.MSG_TYPE_INIT_START;
		m_Handler.sendMessage(msg);
	}
	...
	final public void Init(int taskId) {
		new TestAsyncClass(taskId, m_Handler, false).execute();
	}
	...
	final public void Init(int taskId, boolean showDialog) {
		new TestAsyncClass(taskId, m_Handler, showDialog).execute();
	}
